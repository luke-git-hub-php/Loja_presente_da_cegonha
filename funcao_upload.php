...
$cadastraimg=mysqli_query($conexao,"INSERT INTO produtos (id_prod ,nome_prod,preco,id_cat,imagem,estoque)  VALUES ('','$fild_nome','$preco','$idcat','$nome_final','$estoque')");

mysqli_close($conexao);

echo "<script language='javascript' type='text/javascript'>
 	  alert('PRODUTO CADASTRADO COM SUCESSO');window.location.href='cadastro_produtos.php';
 	</script>";
