    ...
    <tr><main class="servicos container">
             ...
             <th><h2>Produto<h2></th>
              ...
              <tbody>
                ...
                <td> <a href="carrinho.php?acao=add&id='.$linha->id_prod.'"> <br> <img src="img/icone_carrinho.jpg"  /><?php echo '<a href="carrinho.php?acao=add&id='.$linha->id_prod.'"><br><h4><b><i>Comprar</i></b></h4></a>';?></br></a> </td>
...
<h1>Fitros de Pesquisa<h1>
    <form name="cons" method="post" action="index_carrinho.php">
